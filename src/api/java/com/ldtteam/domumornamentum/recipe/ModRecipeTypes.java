...
public class ModRecipeTypes
{
    ...
    public static DeferredHolder<RecipeType<?>, RecipeType<Recipe<?>>> ARCHITECTS_CUTTER  = RECIPES.register("architects_cutter", () -> RecipeType.simple(new ResourceLocation(Constants.MOD_ID, "architects_cutter")));
