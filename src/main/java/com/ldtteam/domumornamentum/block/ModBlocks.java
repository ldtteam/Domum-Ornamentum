...
public final class ModBlocks implements IModBlocks {
    ...
    static {
        ...
        ALL_BRICK.add(register("light_brick", AllBrickBlock::new, b -> new AllBrickBlockItem(b, new Item.Properties().tab(ModCreativeTabs.GENERAL))));
        ALL_BRICK.add(register("dark_brick", AllBrickBlock::new, b -> new AllBrickBlockItem(b, new Item.Properties().tab(ModCreativeTabs.GENERAL))));
