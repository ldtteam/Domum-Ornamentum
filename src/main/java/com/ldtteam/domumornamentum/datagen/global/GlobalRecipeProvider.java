...
public class GlobalRecipeProvider implements DataProvider
{
    ...
    public void run(@NotNull final HashCache cache) throws IOException
    {
        ...
        keys.put("L", new RecipeIngredientKeyJson(new RecipeIngredientJson(BlockTags.LOGS.toString(), true)));
        ...
        standingBarrelKeys.put("W", new RecipeIngredientKeyJson(new RecipeIngredientJson(BlockTags.PLANKS.toString(), true)));
        ...
        layingBarrelKeys.put("W", new RecipeIngredientKeyJson(new RecipeIngredientJson(BlockTags.PLANKS.toString(), true)));
