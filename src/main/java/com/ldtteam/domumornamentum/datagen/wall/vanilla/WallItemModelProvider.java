...
public class WallItemModelProvider implements DataProvider
{
    private final DataGenerator generator;

    public WallItemModelProvider(final DataGenerator generator)
    {
    ...
    public void run(@NotNull CachedOutput cache) throws IOException
    {
        ...
        final String modelLocation = Constants.MOD_ID + ":item/walls/wall_spec";
    ...
    {
        return "Wall Item Model Provider";
    }
}
