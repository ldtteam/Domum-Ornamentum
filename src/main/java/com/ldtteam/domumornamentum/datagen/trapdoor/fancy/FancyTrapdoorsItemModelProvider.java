...
public class FancyTrapdoorsItemModelProvider implements DataProvider
{
    private final DataGenerator generator;

    public FancyTrapdoorsItemModelProvider(final DataGenerator generator)
    {
    ...
    public void run(@NotNull HashCache cache) throws IOException
    {
        ...
        if (ModBlocks.getInstance().getFancyTrapdoor().getRegistryName() == null)
            return;
