...
public class PillarLangEntryProvider implements LanguageProvider.SubProvider
{
    ...
    public void addTranslations(LanguageProvider.LanguageAcceptor acceptor) {
        acceptor.add(Constants.MOD_ID + ".blockpillar.name.format", "Small Square %s Pillar");
        acceptor.add(Constants.MOD_ID + ".blockypillar.name.format", "Tough Square %s Pillar");
